...
import hashlib #导入hash密码的包
import time  # 设置过期时间导入的包
import jwt  # 设置共享秘钥导入的包
from django.conf import settings

# Create your views here.
from django.views import View  # 调用View父类
...
class UsersView(View):  # 父类View，创建视图类需要调用父类View功能
    ...
    def post(self, request):
        ...
        json_obj = json.loads(json_str)  # 反序列化 将json串转换为python对象
