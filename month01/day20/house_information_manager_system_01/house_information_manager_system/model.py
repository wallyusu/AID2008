...
class HouseModel:
    ...
    def __str__(self):
        return f'id:{self.id},标题:{self.title},小区:{self.community},年份:{self.years},房型:{self.house_type},' \
               f'建筑面积:{self.area},底层:{self.floor},描述信息:{self.description},总价:{self.total_price},' \
               f'单价:{self.unit_price},带看记录:{self.follow_info}'
